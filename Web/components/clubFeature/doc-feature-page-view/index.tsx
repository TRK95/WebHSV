...
function DocFeaturePageView({ featureDetail, club, featureSlug, featureId, featureCategories }: { featureDetail: ClubFeatureDetail, club: Club, featureSlug?: string, featureId?: string, featureCategories: Array<ClubFeatureChild> }) {
  const paths = [
    ...
    <Container maxWidth={customMaxWidthContainer()}>
      ...
      {featureDetail ? <div className="detail-news-page-view-content">
        <div className="detail-news-page-view-header">
          <div className="detail-docs-header-title">
            <a href={featureDetail?.docUrl} style={{ marginBottom: '8px' }}>
...
export default DocFeaturePageView;