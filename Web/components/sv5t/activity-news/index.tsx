                        ...
                        <Grid container>
                            <Grid item md={6} sm={12} xs={12}>
                                <Grid item md={12} sm={12} xs={12} style={{ height: "100%", paddingRight: "16px" }}>
                                    <div className="news-item" data-aos="fade-up" onClick={() => router.push(`/${newsArrayData[0]?.slug ? newsArrayData[0].slug : ''}`)} style={{ height: "100%" }}>
                                ...
                                <Grid container style={{ padding: "0 16px", borderRight: '1px solid #EBF1F2', borderLeft: "1px solid #EBF1F2" }}>
                                    <Grid item md={12}>
                                        <div className="news-item" data-aos="fade-up"
                                            ...
                                            onClick={() => router.push(`/${newsArrayData[1]?.slug ? newsArrayData[2].slug : ''}`)} >
                                    ...
                                    <Grid item md={12}>
                                        <div className="news-item" data-aos="fade-up"
                                            ...
                                            onClick={() => router.push(`/${newsArrayData[2]?.slug ? newsArrayData[2].slug : ''}`)} >
                            ...
                            {!isSmallTabletUI && <Grid item md={3} sm={12}>
                                <Grid container style={{ paddingLeft: "16px", rowGap: "8px" }}>
                                    <Grid container spacing={1} style={{ paddingBottom: "8px", borderBottom: "1px solid #EBF1F2" }}>
                                        <Grid item md={5}>
                                            <div className="news-item news-item-row" data-aos="fade-up" onClick={() => router.push(`/${newsArrayData[1]?.slug ? newsArrayData[1].slug : ''}`)} >
                                                <div className="news-desc">
                                                    <div className="news-title small-size-text">{newsArrayData[1]?.title}</div>
                                                </div>
                                            </div>
                                        ...
                                        <Grid item md={7}>
                                            <div className="news-item news-item-row" data-aos="fade-up" onClick={() => router.push(`/${newsArrayData[2]?.slug ? newsArrayData[2].slug : ''}`)} >
                                ...
                                <Grid container spacing={4} >
                                    {newsArrayData.slice(isSmallTabletUI ? 2 : MAX_DATA_DISPLAY, newsArrayData.length).map((item, index) => (
                                        <Grid item sm={6} md={6} lg={4} key={index} >
                                            <div className="news-item" data-aos="fade-up" onClick={() => router.push(`/${item?.slug ? item.slug : ''}`)} >
