            ...
            .then(async (values: NewsCategoryModel) => {
                ...
                if (newsCategoryDetail) {
                    ...
                    if (createRes.status === RESPONSE_SUCCESS) {
                        ...
                        message.success("Tạo danh mục tin tức Sinh viên 5 tốt thành công!")
                    } else if (createRes.status === RESPONSE_FAILED) {
                        message.error("Tạo danh mục tin tức Sinh viên 5 tốt thất bại!")
                    }
                }
                    ...
                    {text.status !== STATUS_DELETED &&
                        <Tooltip title="Xóa">
                            <div style={{ color: 'red', cursor: 'pointer' }}
                                onClick={() => {
                                    Modal.confirm({
                                        title: 'Bạn có muốn xóa danh mục tin tức Sinh viên 5 tốt?',
    ...
    return (
        <>
            <div id="posts">
                <Space>
                    <Button type="primary" onClick={() => {
                        ...
                        form.resetFields()
                    }}>TẠO DANH MỤC TIN TỨC SINH VIÊN 5 TỐT</Button>
            ...
            <Modal
                maskClosable={false}
                centered
                title={!!newsCategoryDetail ? 'Sửa Danh mục tin tức Sinh viên 5 tốt' : 'Tạo Danh mục tin tức Sinh viên 5 tốt'}
                getContainer={false}
                visible={isModalOpen}
                onOk={onFinish}
                onCancel={() => {
