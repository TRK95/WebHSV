            ...
            .then(async (values: NewsCategoryModel) => {
                ...
                if (newsCategoryDetail) {
                    ...
                    if (createRes.status === RESPONSE_SUCCESS) {
                        ...
                        message.success("Tạo danh mục giới thiệu thành công!")
                    } else if (createRes.status === RESPONSE_FAILED) {
                        message.error("Tạo danh mục giới thiệu thất bại!")
                    }
                }
                    ...
                    {text.status !== STATUS_DELETED &&
                        <Tooltip title="Xóa">
                            <div style={{ color: 'red', cursor: 'pointer' }}
                                onClick={() => {
                                    Modal.confirm({
                                        title: 'Bạn có muốn xóa danh mục giới thiệu?',
    ...
    return (
        <>
            <div id="posts">
                <Space>
                    <Button type="primary" onClick={() => {
                        ...
                        form.resetFields()
                    }}>TẠO DANH MỤC GIỚI THIỆU</Button>
            ...
            <Modal
                maskClosable={false}
                centered
                title={!!newsCategoryDetail ? 'Sửa Danh mục giới thiệu' : 'Tạo Danh mục giới thiệu'}
                getContainer={false}
                visible={isModalOpen}
                onOk={onFinish}
                onCancel={() => {
