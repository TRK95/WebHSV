...
const UploadFileNews = (props: {
    ...
    return (
        <>
            <Upload
                // action={`${process.env.API_ENDPOINT_UPLOAD}/api/upload-static-file?baseFolder=${baseFolder}`}
                // action={`${process.env.API_ENDPOINT_UPLOAD}/api/cms-alumni/upload-file?baseFolder=${process.env.BUCKET_BASE_FOLDER ?? 'hust-cms-dev'}`}
                action={`${process.env.API_ENDPOINT_UPLOAD}/api/upload-file?baseFolder=document`}
