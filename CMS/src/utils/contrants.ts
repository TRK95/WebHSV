...
// User Role in HOI SV 
export const ROLE_CHU_TICH_HOI = 1
export const ROLE_PHO_CHU_TICH_HOI = 2
export const ROLE_CHU_TICH_CLB = 3
export const ROLE_PHO_CHU_TICH_CLB = 4
export const ROLE_HOI_VIEN = 5

// Organization
export const TYPE_UNION = 1
export const TYPE_ABOARD = 2
export const TYPE_ASSOCIATION = 3
export const TYPE_CLUB_UNION = 4
export const TYPE_TEAM = 5
...
export const CONTENT_TYPE_INTRODUCE = 4;
export const CONTENT_TYPE_SV5T = 5;
